...
py3dtiles is a Python tool and library for manipulating [3D Tiles](https://github.com/AnalyticalGraphicsInc/3d-tiles)
...
Changes have been made in this fork to better support the Cesium B3DM Batched 3D Models geometry and Feature Tables. Information from the original repository is below.
